...
public class RoomFirstDungeonGenerator : SimpleRandomWalkDungeonGenerator
{
    ...
    private void CreateRooms()
    {
        ...
        HashSet<Vector2Int> walls = WallGenerator.CreateWalls(floor, tilemapVisualizer);

        // Call the dungeon populator with the rooms list and floor positions
        if (dungeonPopulator != null)
        {
            dungeonPopulator.PopulateDungeon(roomsList, floor, walls);
        }
    }
