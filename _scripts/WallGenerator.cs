...
{
    // Modify existing method to return the wall positions
    public static HashSet<Vector2Int> CreateWalls(HashSet<Vector2Int> floorPositions, TilemapVisualizer tilemapVisualizer)
    {
        ...
        // Combine all wall positions for return
        HashSet<Vector2Int> allWallPositions = new HashSet<Vector2Int>(basicWallPositions);
